...
const TENANT_CONFIGS = [
  {
    ...
    name: "Acme DeFi",
    tier: "Pro" as const,
    webhookUrl: "https://acme-defi.example.com/webhooks/paymaster",
  ...
  },
  {
    ...
    webhookUrl: "https://nova-payments.example.io/api/paymaster-events",
  ...
  },
  {
    ...
    name: "Pebble Wallet",
    tier: "Free" as const,
    webhookUrl: "https://pebble.wallet/hooks/paymaster",
