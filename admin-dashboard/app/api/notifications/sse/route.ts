 ...
 *
 * Pass-through SSE proxy: opens an EventSource connection to the Paymaster Express
 * server and streams the events verbatim to the browser client.  This avoids
 * exposing the PAYMASTER_ADMIN_TOKEN and PAYMASTER_SERVER_URL to the frontend.
 */
export async function GET() {
  ...
  const upstreamUrl = `${PAYMASTER_SERVER_URL}/admin/notifications/sse`;
