...
/**
 * A mock version of PaymasterClient for testing purposes.
 * It simulates network calls and returns predefined or randomized responses.
 */
export class PaymasterMockClient extends PaymasterClient {
  private mockResponses: Map<string, any> = new Map();
  private submissionHistory: any[] = [];

  constructor(config: Partial<PaymasterClientConfig> = {}) {
    super({
      networkPassphrase: "Test SDF Network ; September 2015",
      serverUrl: "http://mock-paymaster-server.test",
      ...config as any
    });
  }
