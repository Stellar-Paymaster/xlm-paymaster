...
The XLM Paymaster Admin Dashboard includes a centralized Help Center accessible from the top navigation bar. This integration provides quick access to official documentation, support resources, and community channels.

## Features

- **Direct Documentation Access**: Quick links to the XLM Paymaster developer documentation.
...
- **Community Support**: Integrated links to the XLM Paymaster Discord community.
...
|----------|-------------|---------|
| `NEXT_PUBLIC_DOCS_URL` | XLM Paymaster Documentation URL | `https://docs.xlm-paymaster.com` |
| `NEXT_PUBLIC_HELP_CENTER_URL` | Searchable Knowledge Base URL | `https://help.xlm-paymaster.dev` |
| `NEXT_PUBLIC_SUPPORT_URL` | Support Ticket Portal URL | `https://support.xlm-paymaster.dev/tickets` |
| `NEXT_PUBLIC_DISCORD_URL` | Community Discord Invite Link | `https://discord.gg/xlm-paymaster` |
